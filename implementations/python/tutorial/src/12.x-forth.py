'''
In part 12 we'll add the new string type and the ability to print it, finally in 13 we'll add some words to work with strings.
'''
import traceback
import sys
import os.path
...
if len(args := sys.argv[1:]) > 0:
    ...
    # other programs
#     src = '''
# "x-forth strings can span
# multiple lines" dup type . .
#     '''
#     # output
#     # String:
#     # x-forth strings can span
